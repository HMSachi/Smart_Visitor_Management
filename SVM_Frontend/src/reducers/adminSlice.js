...
const initialState = {
    ...
    alerts: [
      {
        id: 1,
        type: "critical",
        message: "Unauthorized access attempt in Zone B",
        time: "2 mins ago",
      },
      {
        id: 2,
        type: "warning",
        message: "Visitor duration exceeded in Lobby",
        time: "15 mins ago",
      },
      {
        id: 3,
        type: "info",
        message: "New VIP visitor registered",
        time: "1 hour ago",
      },
    ],
  },
  ...
  monitoring: {
    alerts: [
      {
        type: "Unauthorized Zone Breach",
        location: "Server Room - Level 2",
        time: "12:44 PM",
        severity: "high",
      },
      {
        type: "ID Card Scan Failure",
        location: "Main Entrance Gate",
        time: "12:38 PM",
        severity: "low",
      },
      {
        type: "Extended Stay Alert",
