...
const GetAllContactPersons = async () => {
  let config = {
    method: "get",
    url: getApiUrl("/ContactPerson/GetAllContactPersons"),
  };
  return axios.request(config).then((response) => {
    return response;
  });
...
const GetContactPersonById = async (id) => {
  let config = {
    method: "get",
    url: getApiUrl(
      `/ContactPerson/GetContactPersonById?VCP_Contact_person_id=${encodeURIComponent(id)}`,
    ),
  };
  return axios.request(config).then((response) => {
    return response;
...
const GetActiveContactPersons = async () => {
  let config = {
    method: "get",
    url: getApiUrl("/ContactPerson/GetActiveContactPersons"),
  };
  return axios.request(config).then((response) => {
    return response;
  });
