...
const GetAllVisitors = async () => {
  let config = {
    method: "get",
    url: getApiUrl("/Visitor/GetAllVisitors"),
  };
...
const GetVisitorById = async (id) => {
  let config = {
    method: "get",
    url: getApiUrl(
      `/Visitor/GetVisitorById?VV_Visitor_id=${encodeURIComponent(id)}`,
    ),
  };
  return axios.request(config).then((response) => response);
};
...
const ActivateVisitor = async (id, status) => {
  let config = {
    method: "post",
    url: getApiUrl(
      `/Visitor/ActivateVisitor?VV_Status=${encodeURIComponent(status)}&VV_Visitor_id=${encodeURIComponent(id)}`,
    ),
    data: "",
  };
  return axios.request(config).then((response) => response);
...
const GetVisitorsByContactPerson = async (cpId) => {
  let config = {
    method: "get",
    url: getApiUrl(
      `/Visitor/GetVisitorsByContactPerson?VV_Contact_person_id=${encodeURIComponent(cpId)}`,
    ),
  };
  return axios.request(config).then((response) => response);
};
