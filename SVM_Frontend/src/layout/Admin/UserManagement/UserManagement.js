...
const UserManagement = () => {
  ...
  const handleToggleStatus = (item) => {
    ...
    const statusValue = (item.VCP_Status || item.VA_Status || "")
      .toString()
      .trim()
      .toUpperCase();
  ...
  const getFilteredAdmins = () => {
    ...
    return administrators.filter(
      (admin) =>
        admin.VA_Role === role &&
        (!searchTerm ||
          admin.VA_Name?.toLowerCase().includes(searchTerm.toLowerCase())),
    );
  };
        ...
        <div className="max-w-[1600px] mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 mt-6 border-t border-white/5 pt-4">
                {["CONTACT", "SECURITY", "VISITOR"].map((tab) => (
                  <button
                    ...
                    className={`px-1 py-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.16em] sm:tracking-[0.18em] transition-all relative ${
                      activeTab === tab
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-4 items-center">
                ...
                {activeTab === "CONTACT" && (
                  <Button
                    ...
                    variant="outlined"
                    className={`rounded-none px-4 py-2 text-[10px] sm:text-[11px] font-bold tracking-widest transition-all ${
                      showActiveOnly
                ...
                {activeTab === "CONTACT" && (
                  <Button
                    ...
                    className="bg-primary hover:bg-[var(--color-primary-hover)] rounded-none px-6 py-2.5 text-[10px] sm:text-[11px] font-bold tracking-[0.16em] sm:tracking-[0.18em]"
                    sx={{ borderRadius: 0 }}
                  >
                    ADD {activeTab}
                  </Button>
          ...
          {isFormVisible ? (
            <form
              ...
              className="p-8 bg-[#0F0F10] border border-white/5 space-y-6 mb-8 relative"
            >
              <IconButton
              ...
              {message && (
                <Alert
                  severity="success"
                  className="rounded-none bg-green-500/10 border border-green-500/50 text-green-400"
                >
                  {message}
                </Alert>
              )}
              {error && (
                <Alert
                  severity="error"
                  className="rounded-none bg-red-500/10 border border-red-500/50 text-red-500"
                >
                  {error}
                </Alert>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group space-y-2">
                  <label className="text-[12px] font-medium tracking-[0.2em] text-white/40 uppercase ml-1 block">
                    Full Name
                  </label>
                  <TextField
                    fullWidth
                    ...
                    InputProps={{
                      className:
                        "rounded-none bg-black/60 border-white/5 text-sm text-white transition-all focus-within:bg-black",
                    }}
                    sx={{
                ...
                <div className="group space-y-2">
                  ...
                  <TextField
                    ...
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: validation.emailError
                            ? "var(--color-primary)"
                ...
                <div className="group space-y-2">
                  ...
                  <TextField
                    ...
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        "& fieldset": {
                          borderColor: validation.phoneError
                            ? "var(--color-primary)"
                            : "rgba(255,255,255,0.1)",
                        },
                        "&:hover fieldset": {
              ...
              <div className="flex justify-end pt-6 border-t border-white/5 gap-4">
                <Button
                  ...
                  type="button"
                  variant="outlined"
                  className="border-white/10 text-white/70 hover:bg-white/5 rounded-none px-6 py-2.5 text-xs font-bold tracking-[0.2em]"
                  sx={{ borderRadius: 0 }}
                >
                  CANCEL
                </Button>
            ...
            <TableContainer
              component={Paper}
              className="bg-[#0F0F10] border border-white/5 rounded-none"
            >
                ...
                <TableBody>
                  ...
                  (activeTab === "CONTACT"
                    ...
                    (activeTab === "CONTACT"
                      ...
                      <TableRow
                        key={item.VCP_Contact_person_id || item.VA_Admin_id}
                        sx={{
                      ...
                      >
                        ...
                        <TableCell align="right" className="border-b-white/5">
                          {activeTab === "CONTACT" ? (
                            ...
                            <span className="text-[10px] text-white/20 uppercase tracking-widest italic">
                              Read Only
                            </span>
                          )}
                        </TableCell>
