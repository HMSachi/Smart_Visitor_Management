    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            if (password === '123456') {
                ...
                else if (email === 'contact@company.com') navigate('/contact_person/dashboard');
                else if (email === 'security@company.com') navigate('/security-dashboard');
                else if (email === 'visitor@company.com') navigate('/home');
                else setLocalError('Access denied. No role profile found for this identifier.');
            } else {
    ...
    return (
        <div className="min-h-screen bg-[#020202] text-white flex flex-col md:flex-row relative overflow-hidden font-sans selection:bg-mas-red/30">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                {[...Array(15)].map((_, i) => (
                    <motion.div
                        ...
                        animate={{ opacity: [0, 0.4, 0], y: '-100%', x: `${(Math.random() - 0.5) * 50}px` }}
            ...
            <div className="relative z-10 flex flex-col w-full md:w-[45%] lg:w-[40%] items-center justify-center p-6 md:p-12 py-12 md:py-0 bg-black/40 backdrop-blur-sm border-b md:border-b-0 md:border-r border-white/5">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[500px] h-[300px] md:h-[500px] rounded-[0px] blur-[150px] bg-mas-red/10 opacity-30 animate-pulse-glow" style={{ animationDuration: '8s' }} />
                                ...
                                <TextField
                                    ...
                                    sx={{
                                        '& .MuiOutlinedInput-root': {
                                            ...
                                            '&:hover fieldset': { borderColor: 'rgba(149, 138, 138, 0.1)' },
                            ...
                            <div className="group space-y-2">
                                ...
                                <TextField
                                    ...
                                    InputProps={{
                                        ...
                                        className: "rounded-none bg-black/60 border-white/5 text-xs text-white tracking-widest transition-all focus-within:bg-black group-hover:border-white/10"
                                    }}
                                    sx={{
                                        '& .MuiOutlinedInput-root': {
