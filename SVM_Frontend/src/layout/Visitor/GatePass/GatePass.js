  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg-default)] text-white px-4 md:px-8 pt-24 md:pt-28 pb-6 md:pb-8 relative overflow-hidden">
      ...
      <div className="max-w-[960px] mx-auto relative z-10">
        ...
        <div className="w-full max-w-lg mx-auto bg-[#161618]/95 backdrop-blur-3xl border border-white/20 shadow-[0_30px_100px_rgba(0,0,0,1)] rounded-[48px] overflow-hidden relative">
            ...
            {qrPayload ? (
              <>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white text-lg font-medium capitalize tracking-widest">
                    {visitorName}
                  </p>
          ...
          <div className="p-8 border-t border-white/5 bg-white/[0.01] relative z-10 flex flex-col md:flex-row gap-4 md:gap-4">
            ...
            <button
              onClick={() => navigate("/visitor/my-requests")}
              className="py-4 px-8 border border-white/10 text-white text-[11px] font-bold capitalize tracking-[0.2em] rounded-2xl hover:bg-white/5 transition-all"
            >
              Conclude
            </button>
          </div>
