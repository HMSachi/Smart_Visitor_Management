                ...
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                    <div className="flex flex-col items-center md:items-start gap-2">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-400 font-bold tracking-tighter text-[13px] uppercase">Access <span className="text-mas-red/80">Portal</span></span>
                        </div>
                    ...
                    <div className="flex items-center gap-6">
                        <Link to="/privacy" className="text-[14px] font-bold uppercase tracking-widest text-gray-700 hover:text-mas-red transition-colors">Privacy</Link>
                        <Link to="/terms" className="text-[14px] font-bold uppercase tracking-widest text-gray-700 hover:text-mas-red transition-colors">Terms</Link>
                    </div>
                </div>
            </footer>
        </div>
