    ...
    >
      ...
      <div
        className={`absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl -mr-16 -mt-16 transition-all duration-700 ${
          isWarning
            ? "bg-mas-red/20 group-hover:bg-mas-red/40"
      ...
      <div className="flex items-center gap-4 mb-10 relative z-10">
        <div
          className={`p-3 rounded-xl flex items-center justify-center ${
            isWarning
              ? "bg-mas-red text-white shadow-[0_0_15px_#C8102E]"
        ...
        <div>
          <h3
            className={`text-xl font-medium uppercase tracking-tight italic ${
          ...
          <p
            className={`text-[9px] font-medium uppercase tracking-[0.2em] ${isWarning ? "text-mas-red/60" : "text-gray-500"}`}
          >
            Protocol Category
          </p>
        </div>
      ...
      <ul className="space-y-6 relative z-10">
        {items.map((item, idx) => (
          ...
          >
            <div
              className={`mt-1.5 mr-4 shrink-0 transition-transform duration-300 group-hover/item:scale-125 flex items-center justify-center ${
                isWarning
                  ? "text-mas-red"
            ...
            <span
              className={`text-[11px] font-medium leading-relaxed tracking-wide uppercase ${
                isWarning
                  ? "text-mas-red/80 group-hover/item:text-mas-red"
