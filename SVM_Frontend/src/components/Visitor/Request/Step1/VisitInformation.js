  ...
  return (
    <section className="animate-fade-in stagger-item">
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-3 mb-6">
        ...
        <h3 className="text-sm font-semibold text-white uppercase tracking-wider transition-all">
          Visit Logistics
        </h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 px-4 py-6 rounded-xl border border-white/5 bg-white/[0.01]">
        ...
        <div className="flex items-center justify-between px-5 py-3 rounded-xl border border-white/5 bg-white/[0.01]">
          <div className="flex flex-col">
            <label className="text-[14px] font-medium text-gray-400 uppercase tracking-widest">
              Corporate Business?
            </label>
            <span className="text-[13px] text-gray-600 font-medium tracking-tight">
              MAS Holdings Related
            </span>
          </div>
          <button
            type="button"
          ...
          >
            <div
              className={`w-4 h-4 mas-glass rounded-full transition-transform duration-300 ${data.isCompanyRelated ? "translate-x-5" : "translate-x-0"}`}
            ></div>
          </button>
        </div>
