...
import { Package, Plus, X, Save, Edit2, Loader2 } from 'lucide-react';
import { AnimatePresence } from 'framer-motion';

const EquipmentDeclaration = ({ items, onAdd, onRemove, onChange, onSave, savingId }) => {
    return (
                        ...
                        >
                            ...
                            <div className="md:col-span-2 flex items-end justify-end gap-1">
                                <button
                                    ...
                                    title={item.isConfirmed ? 'Edit Item' : 'Save Item'}
