        ...
        <section className="animate-fade-in stagger-item">
            <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white uppercase tracking-tight">Asset Declaration</h2>
                        <p className="text-gray-500 text-[10px] font-medium uppercase tracking-[0.2em]">Equipment & Hardware Inventory</p>
                    </div>
                </div>
                <button 
                    type="button" 
            ...
            <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div className="space-y-3">
                                    <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">Asset Name</label>
                                ...
                                <div className="space-y-3">
                                    <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">Quantity</label>
                                    <div className="relative">
                                ...
                                <div className="md:col-span-2 space-y-3">
                                    <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">Specifications / Description</label>
                                    <div className="relative">
                ...
                {items.length === 0 && (
                    <div className="p-16 border-2 border-dashed border-white/5 rounded-[2.5rem] flex flex-col items-center justify-center text-center group hover:border-mas-red/20 transition-all">
                        ...
                        <p className="text-gray-600 text-[10px] font-medium uppercase tracking-[0.2em] mb-8 max-w-[200px] leading-relaxed">No hardware assets declared in current protocol.</p>
                        <button 
                            type="button" 
                            onClick={onAdd}
