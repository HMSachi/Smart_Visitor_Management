        ...
        <section className="stagger-item">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-600 text-[12px] font-bold uppercase tracking-widest">Initial Parameters</p>
                </div>
            </div>
                    ...
                    <div className="md:col-span-2 group/item">
                        ...
                        <div className="pl-5 flex flex-wrap gap-2">
                            {(summary.areas || []).length > 0 ? (
                                ...
                                <span className="text-gray-800 text-[13px] font-bold uppercase tracking-widest">No Zones Designated</span>
                            )}
                        </div>
                    </div>
                </div>
