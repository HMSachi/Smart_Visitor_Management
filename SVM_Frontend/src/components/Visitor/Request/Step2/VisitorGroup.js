        ...
        <section className="animate-fade-in stagger-item">
            <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white uppercase tracking-tight">Visitor Group</h2>
                        <p className="text-gray-500 text-[10px] font-medium uppercase tracking-[0.2em]">Secondary Node Identification</p>
                    </div>
                </div>
                <button 
                    type="button" 
                    onClick={onAdd} 
                    className="flex items-center gap-2 px-5 py-3 bg-mas-red/10 border border-mas-red/20 text-mas-red rounded-xl hover:bg-mas-red hover:text-white transition-all text-[10px] font-medium uppercase tracking-widest group"
                >
            ...
            <div className="space-y-6">
                    ...
                    {visitors.map((visitor, index) => (
                        ...
                        >
                            ...
                            <div className="absolute top-4 left-6 flex items-center gap-2">
                                ...
                                <span className="text-[8px] font-medium text-gray-600 uppercase tracking-[0.3em]">Node 0{index + 1}</span>
                            </div>

                            <div className="space-y-3 pt-4">
                                <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">Full Name</label>
                            ...
                            <div className="space-y-3 pt-4">
                                <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">NIC / Passport</label>
                                <div className="relative">
                            ...
                            <div className="space-y-3 pt-4">
                                <label className="text-[9px] font-medium uppercase tracking-widest text-gray-500 block">Contact</label>
                                <div className="relative">
                ...
                {visitors.length === 0 && (
                    <div className="p-16 border-2 border-dashed border-white/5 rounded-[2.5rem] flex flex-col items-center justify-center text-center group hover:border-mas-red/20 transition-all">
                        ...
                        <p className="text-gray-600 text-[10px] font-medium uppercase tracking-[0.2em] mb-8 max-w-[200px] leading-relaxed">No secondary visitors declared in current protocol.</p>
                        <button 
                            type="button" 
                            onClick={onAdd}
                            className="px-8 py-4 bg-white/[0.03] border border-white/10 text-white text-[10px] font-medium uppercase tracking-widest rounded-2xl hover:bg-mas-red hover:border-mas-red transition-all"
                        >
                            Declare Visitor
                        </button>
                    </div>
