...
const AccessControl = () => {
  ...
  const AccessTimeline = () => {
    ...
    return (
      <div className="mt-6 pt-6 border-t border-[var(--color-border-soft)]">
        <h4 className="text-[var(--color-text-primary)] text-sm font-bold mb-4 uppercase tracking-wide">
          Today's Access Log
        </h4>
        <div className="space-y-2">
          {timeline.map((item, idx) => (
            ...
            >
              ...
              <span className="text-[var(--color-text-secondary)] opacity-75">
                {item.visitor}
              </span>
            </motion.div>
          ))}
  ...
  return (
    ...
    >
      <div className="mb-6">
        <h2 className="text-[var(--color-text-primary)] text-lg md:text-xl font-bold tracking-tight">
          Access Control
        </h2>
