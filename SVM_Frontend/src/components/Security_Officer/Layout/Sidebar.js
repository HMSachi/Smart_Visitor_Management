        ...
        <div className={`flex items-center gap-4 ${isCollapsed ? 'justify-center' : 'px-2'}`}>
            ...
            {!isCollapsed && (
                <div className="animate-fade-in overflow-hidden">
                    <p className="text-white text-[13px] font-medium uppercase tracking-wider truncate">Guardian</p>
                    <p className="text-gray-500 text-[14px] uppercase tracking-widest truncate">Security Node</p>
                </div>
            )}
        </div>
      </div>
