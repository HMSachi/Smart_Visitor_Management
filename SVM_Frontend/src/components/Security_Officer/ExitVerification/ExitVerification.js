            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10 border-b border-white/5 pb-10">
                <div className="space-y-4">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-mas-red font-medium uppercase text-[13px] tracking-[0.4em]">Operational_Exit_Protocol</span>
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex flex-col text-right">
                        ...
                        <p className="text-mas-red text-sm font-medium tracking-widest">ENFORCED</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
                                ...
                                >
                                    <div className="flex items-center gap-8 relative z-10">
                                        ...
                                        <div className="space-y-1">
                                            <p className={`text-sm font-medium tracking-widest transition-all duration-300 uppercase ${item.mismatch ? 'text-mas-red' : 'text-white'}`}>{item.name}</p>
                                            <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-6 relative z-10">
                                        <span className={`text-[13px] font-medium uppercase tracking-widest transition-all duration-300 ${item.mismatch ? 'text-mas-red animate-bounce' : 'text-gray-300/80 group-hover:text-white'}`}>{item.status}</span>
                            ...
                            <div className="mx-10 mb-10 p-8 bg-mas-red/10 border border-mas-red/20 rounded-2xl relative group/warning cursor-help">
                                ...
                                <div className="relative z-10 flex items-start gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <h4 className="text-white text-sm font-medium uppercase tracking-widest group-hover/warning:text-mas-red transition-colors">Asset_Mismatch_Protocol_Engaged</h4>
                ...
                <div className="space-y-8">
                                    ...
                                    <div className="flex gap-6 items-center relative z-10">
                                        ...
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-3">
                                                ...
                                                {isAuth && <span className="text-mas-red text-[14px] font-medium animate-pulse tracking-[0.3em]">SYNCING...</span>}
                                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <button className="group relative overflow-hidden w-full py-5 rounded-2xl border border-mas-red text-mas-red bg-transparent font-medium uppercase text-[14px] tracking-[0.4em] hover:bg-mas-red hover:text-white transition-all duration-700 flex items-center justify-center gap-4 shadow-xl active:scale-95">
                    ...
                    <div className="mas-glass p-8 border-mas-red/10 bg-[#121214]/60 backdrop-blur-3xl rounded-[28px] border text-center flex flex-col items-center gap-3 group/footer hover:border-mas-red/30 transition-all">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="uppercase text-mas-red font-medium text-[13px] tracking-[0.4em]">Guardian_Node_Registry_Active</span>
                        </div>
