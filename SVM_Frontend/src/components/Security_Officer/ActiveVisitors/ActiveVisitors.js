...
const getInTime  = (log) => getField(log, "VVL_Created_Date", "VVL_Check_In_Time",  "VVL_In_Time", "Created_Date", "CreatedDate") || log?.checkInTime;
const getOutTime = (log) => getField(log, "VVL_Check_Out_Time", "VVL_Out_Time", "VVL_CheckOutTime") || log?.checkOutTime;
const getPassId  = (log) => cleanPassId(getField(log, "VVL_Pass_id", "VGP_Pass_id", "PassId", "Pass_id") || log?.passId);
const getVisitId = (log) => getField(log, "VVL_Visit_id", "VisitLogId", "id") || log?.id;
