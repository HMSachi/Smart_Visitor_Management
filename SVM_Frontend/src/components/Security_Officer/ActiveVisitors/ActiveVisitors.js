  ...
  const activeVisitors = [
    {
      ...
      date: "2026-03-31",
      entryTime: "08:45:12 AM",
      areas: ["Alpha_Production", "Storage_Beta"],
      status: "Active",
      ref: "SEC-4291",
      node: "GATE_01",
      urgency: "Low",
    ...
    },
    {
      ...
      name: "Sahan Perera",
      date: "2026-03-31",
      entryTime: "09:20:44 AM",
      areas: ["Main_Operations"],
      status: "Active",
      ref: "SEC-4310",
      node: "GATE_02",
      urgency: "Med",
      vehicle: "Honda Civic (WP CB-5678)",
    ...
    },
    {
      ...
      name: "Emma Watson",
      date: "2026-03-31",
      entryTime: "11:05:33 AM",
      areas: ["HQ_Admin", "Operations"],
      status: "Active",
      ref: "SEC-4415",
      node: "GATE_01",
      urgency: "High",
      vehicle: "Range Rover (WP KIA-9999)",
      phone: "+1 555 0198",
      company: "VIP Guest",
  ...
  return (
    <div className="p-8 md:p-12 space-y-10 min-h-full bg-[var(--color-bg-default)]">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-10">
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-4">
            ...
            <span className="text-primary font-medium uppercase text-[13px] tracking-[0.4em]">
              Real-Time_Operational_Monitor
            </span>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          >
            <RefreshCw
              size={18}
              className={`${isSyncing ? "animate-spin" : "group-hover:scale-110"} transition-transform duration-700`}
            />
          </button>
          <div className="hidden lg:flex flex-col text-right">
            <p className="text-gray-300/80 text-[14px] font-medium uppercase tracking-widest">
              Global_Sync_Time
            </p>
            <p className="text-white text-sm font-mono font-medium tracking-widest">
              {currentTime}
            </p>
          </div>
        </div>
      ...
      <div className="relative group">
        ...
        <div className="relative mas-glass bg-[var(--color-bg-paper)]/60 backdrop-blur-3xl rounded-[32px] overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.4)] border border-white/10">
          <div className="overflow-x-auto">
            <div className="overflow-x-auto w-full max-w-full pb-4">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-white/[0.02] border-b border-white/5">
                    <th className="px-10 py-7 uppercase text-white/90 text-[13px] font-medium tracking-[0.4em]">
                      Unit_Identification
                    </th>
                    <th className="px-10 py-7 uppercase text-white/90 text-[13px] font-medium tracking-[0.4em]">
                      Node_Sync_Entry
                    ...
                    <th className="px-10 py-7 uppercase text-white/90 text-[13px] font-medium tracking-[0.4em] text-center">
                      Live_Pulse
                    </th>
                    <th className="px-10 py-7 uppercase text-white/90 text-[13px] font-medium tracking-[0.4em] text-right">
                      Control
                    </th>
                  </tr>
                </thead>
                        ...
                        >
                          <td className="px-10 py-8">
                            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                              ...
                              <div>
                                <p className="text-[13px] font-medium text-white uppercase tracking-wider group-hover:text-primary transition-colors duration-300">
                                  {v.name}
                                </p>
                                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-2 mt-1">
                                  ...
                                  />
                                  <p className="text-white/90 text-[12px] font-medium tracking-widest uppercase">
                                    {v.ref}
                                  </p>
                                </div>
                              </div>
                          ...
                          <td className="px-10 py-8">
                            <div className="space-y-1.5">
                              <div className="flex flex-col md:flex-row items-center gap-4 md:gap-2.5">
                                ...
                                />
                                <span className="text-white text-[13px] font-medium tracking-widest">
                                  {v.date}
                                </span>
                              </div>
                              <div className="flex flex-col md:flex-row items-center gap-4 md:gap-2.5 ml-2">
                                ...
                                />
                                <span className="text-white/70 text-[13px] font-medium tracking-widest">
                                  {v.entryTime}
                                </span>
                              </div>
                              <p className="text-white/80 text-[13px] font-medium uppercase tracking-widest ml-5">
                                via_{v.node}
                              </p>
                            </div>
                          </td>
                          <td className="px-10 py-8">
                            <div className="flex flex-wrap gap-2.5 max-w-[280px]">
                              {v.areas.map((area, i) => (
                                <span
                                  key={i}
                                  className="px-3 py-1 rounded-md bg-white/5 border border-white/10 text-white/70 text-[13px] font-medium uppercase tracking-widest group-hover:border-primary/40 group-hover:text-white transition-all duration-300"
                                >
                                  {area}
                                </span>
                              ))}
                          ...
                          <td className="px-10 py-8">
                            <div className="flex flex-col items-center gap-2">
                              ...
                              <span className="text-green-500/80 text-[13px] font-medium uppercase tracking-widest">
                                INSIDE_DOME
                              </span>
                            </div>
                          </td>
                          <td className="px-10 py-8 text-right">
                            <button
                              ...
                              className={`p-3 mas-glass border-white/5 text-white/70 hover:text-white hover:border-primary/40 transition-all rounded-xl shadow-lg ${expandedVisitor === v.id ? "bg-primary border-primary text-white" : "hover:bg-primary/5"}`}
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
                                  <div className="space-y-2">
                                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-2 text-gray-300/90 mb-2">
                                      ...
                                      />
                                      <span className="text-[12px] font-medium uppercase tracking-[0.3em]">
                                        Vehicle Details
                                      </span>
                                    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
          {
            label: "Latest_Entry_Node",
            val: "SEC-4415 | Emma W.",
            detail: "GATE_01 | 11:05:33",
            icon: Zap,
            color: "mas-red",
          },
          {
            label: "Zone_Operations",
            val: "04 Units_Sync",
            detail: "3 SECTORS_COVERED",
            icon: Shield,
            color: "white",
          },
          {
            ...
            val: "Active_Sync: 100%",
            detail: "NODE_HEALTH: EXCELLENT",
            icon: RefreshCw,
            color: "white",
          },
          {
            label: "Global_Visibility",
            val: "Encrypted_Stream",
            detail: "PROTOCOL_V2_ACTIVE",
            icon: Globe,
            color: "mas-red",
          },
        ].map((stat, i) => (
          ...
          >
            <div className="flex items-center justify-between">
              <p className="text-gray-300/80 text-[12px] font-medium uppercase tracking-[0.3em]">
                {stat.label}
              </p>
              <stat.icon
                size={16}
                className={
                  stat.color === "mas-red" ? "text-primary" : "text-gray-300/80"
                }
              />
            </div>
            <div className="space-y-1">
              ...
              <p className="text-gray-300/80 text-[12px] font-medium tracking-widest uppercase">
                {stat.detail}
              </p>
            </div>
          </motion.div>
