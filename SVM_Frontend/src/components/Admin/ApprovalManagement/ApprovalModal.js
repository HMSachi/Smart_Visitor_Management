            ...
            >
              ...
              <div className="p-8 border-b border-white/5 flex justify-between items-center bg-white/[0.01] relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-4">
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-colors ${type === "Approve" ? "bg-green-500/10 border-green-500/20 text-green-500" : "bg-primary/10 border-primary/20 text-primary"}`}
                  >
                    {type === "Approve" ? (
              ...
              <form
                ...
                className="p-8 space-y-4 md:space-y-8 relative z-10"
              >
                <div className="p-6 bg-[var(--color-bg-paper)] border border-white/5 rounded-2xl shadow-inner flex justify-between items-center group/target hover:border-primary/20 transition-all duration-500">
                  <div className="flex flex-col md:flex-row items-center gap-4 md:gap-4">
                    ...
                    <div>
                      <p className="text-gray-300/80 text-[12px] font-medium capitalize tracking-widest mb-1">
                        Target Subject Identity
                      </p>
                      <p className="text-white text-sm font-medium capitalize tracking-widest group-hover:text-primary transition-colors">
                        {visitor?.name}
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-gray-300/90 text-[14px] font-mono tracking-wider">
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    placeholder={
                      type === "Approve"
                        ? "Append authorization remarks (optional)..."
                        : "Specify refusal rationale (mandatory field)..."
                    }
