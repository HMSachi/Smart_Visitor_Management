        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 w-full xl:w-auto">
          <div className="relative group flex-1 xl:w-96 w-full">
            <input
              ...
              className="w-full pl-12 pr-6 py-4 bg-[var(--color-bg-default)] border border-white/5 rounded-2xl uppercase text-[13px] font-medium tracking-[0.2em] text-white placeholder:opacity-70 focus:border-primary/40 outline-none transition-all shadow-xl group-hover:border-white/10"
              value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
            ...
            <button className="w-full sm:w-auto flex-1 items-center justify-center gap-3 px-8 py-4 bg-primary text-white border border-transparent rounded-2xl uppercase text-[13px] font-medium tracking-[0.3em] hover:bg-red-500 transition-all group shrink-0 shadow-[0_10px_20px_rgba(200,16,46,0.2)] flex">
        ...
        <table className="w-full text-left border-separate border-spacing-y-4 sm:border-spacing-y-0 sm:border-collapse min-w-0 sm:min-w-[700px] block sm:table">
          <thead className="hidden sm:table-header-group">
            <tr className="bg-[var(--color-bg-paper)] border-b border-white/5">
              ...
              <th className="px-6 md:px-10 py-6 text-[13px] font-medium tracking-[0.3em] uppercase text-primary text-right pr-6 md:pr-12 whitespace-nowrap">Control</th>
            </tr>
          </thead>
              ...
              {filtered.map((item, idx) => (
                ...
                >
                  <td className="block sm:table-cell px-2 sm:px-6 md:px-10 py-4 sm:py-8 border-b border-white/5 sm:border-none">
                    <span className="text-[14px] font-bold tracking-[0.2em] text-primary/60 uppercase block sm:hidden mb-4">Identity Identifier</span>
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                      ...
                      <div>
                        <p className="text-white uppercase text-[12px] font-medium tracking-widest mb-1.5 group-hover:text-primary transition-colors break-words">{item.name}</p>
                  ...
                  <td className="block sm:table-cell px-2 sm:px-10 py-4 sm:py-8 border-b border-white/5 sm:border-none">
                    <span className="text-[14px] font-bold tracking-[0.2em] text-primary/60 uppercase block sm:hidden mb-4">Operational Restriction</span>
                  ...
                  <td className="block sm:table-cell px-2 sm:px-10 py-4 sm:py-8 border-b border-white/5 sm:border-none">
                    <span className="text-[14px] font-bold tracking-[0.2em] text-primary/60 uppercase block sm:hidden mb-4">Threat Level</span>
                    <RestrictionLevel level={item.level} />
                  </td>
                  <td className="block sm:table-cell px-2 sm:px-10 py-4 sm:py-8 text-right sm:pr-12">
                    <span className="text-[14px] font-bold tracking-[0.2em] text-primary/60 uppercase block sm:hidden mb-4 text-left">Control Options</span>
