            ...
            >
                ...
                <div className="mb-6 relative z-10">
                    <div className="flex flex-col md:flex-row items-center gap-3 md:gap-3 mb-2">
                        ...
                        <h2 className={`text-sm font-bold tracking-[0.08em] ${isLight ? 'text-[#1A1A1A]' : 'text-white'}`}>Reject Request</h2>
                    </div>
                    <p className={`text-[12px] font-medium ${isLight ? 'text-gray-500' : 'text-gray-300/80'}`}>
                ...
                <div className="space-y-4 mb-6 relative z-10">
                    <div className="space-y-3">
                        <label className={`text-[11px] font-semibold uppercase tracking-[0.12em] ${isLight ? 'text-gray-500' : 'text-gray-300'}`}>
                            Rejection Reason
                        </label>
                        <select
                        ...
                        >
                            <option value="" className={isLight ? 'bg-white text-[#1A1A1A]' : 'bg-[var(--color-bg-paper)] text-white'}>Select a reason</option>
                            <option value="invalid_id" className={isLight ? 'bg-white text-[#1A1A1A]' : 'bg-[var(--color-bg-paper)] text-white'}>Invalid ID or passport details</option>
                            <option value="access_denied" className={isLight ? 'bg-white text-[#1A1A1A]' : 'bg-[var(--color-bg-paper)] text-white'}>Access is not allowed for this visit</option>
                            <option value="duplicate" className={isLight ? 'bg-white text-[#1A1A1A]' : 'bg-[var(--color-bg-paper)] text-white'}>Duplicate request</option>
                            <option value="other" className={isLight ? 'bg-white text-[#1A1A1A]' : 'bg-[var(--color-bg-paper)] text-white'}>Other reason</option>
                        </select>
                    </div>
