            ...
            <div className="w-full max-w-xl bg-[#121214] border border-white/5 rounded-[40px] p-12 relative z-10 animate-fade-in shadow-2xl overflow-hidden group">
                ...
                <div className="mb-10 relative z-10">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <h2 className="text-white text-xs font-black uppercase tracking-[0.3em]">Protocol Approval</h2>
                    </div>
                    <p className="text-mas-text-dim text-[10px] font-black uppercase tracking-widest opacity-40">Dispatch authorization to administrative nodes</p>
                </div>

                <div className="space-y-6 mb-12 relative z-10">
                    <div className="space-y-3">
                        <label className="text-mas-text-dim text-[9px] font-black uppercase tracking-widest">Personnel Observations</label>
                        <textarea
                            rows="4"
