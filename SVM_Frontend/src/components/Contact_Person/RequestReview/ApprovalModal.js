...
const ApprovalModal = ({ isOpen, onClose, onConfirm, comment, setComment }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <div className="w-full max-w-xl bg-[var(--color-bg-paper)] border border-white/5 rounded-[40px] p-6 md:p-12 relative z-10 animate-fade-in shadow-2xl overflow-hidden group">
