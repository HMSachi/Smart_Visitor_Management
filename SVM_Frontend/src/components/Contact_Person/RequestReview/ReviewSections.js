...
export const VisitorIdentification = ({ request }) => (
    <div className="bg-[var(--color-bg-paper)] border border-white/5 rounded-[32px] p-6 md:p-10 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 md:px-6">
...
export const VisitParameters = ({ request }) => (
    <div className="bg-[var(--color-bg-paper)] border border-white/5 rounded-[32px] p-6 md:p-10 shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 md:px-6 mb-8">
            <Field label="Proposed Visit Date" value={formatDate(request?.visitDate)} icon={Calendar} />
            <Field label="Purpose of Visitation" value={readablePurpose(request?.purpose, request?.purposeOther)} />
