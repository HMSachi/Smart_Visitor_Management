            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed right-0 top-0 h-full w-full max-w-lg bg-[#0F0F10] border-l border-mas-red/30 z-[101] shadow-2xl p-12 overflow-y-auto"
                    >
                        ...
                        <div className="space-y-12">
                            ...
                            <section>
                                <label className="text-mas-red uppercase mb-6 block">Node Destination</label>
                                <div className="p-6 bg-white/[0.02] border border-white/5 flex items-center gap-4">
                                    <MapPin size={18} className="text-mas-red" />
                            ...
                            <section className="pt-8 border-t border-mas-border">
                                ...
                                <div className="bg-white/[0.02] border border-white/5 p-8 flex flex-col items-center justify-center mb-8 relative group cursor-crosshair">
                                    ...
                                    <div className="absolute top-8 left-1/2 -ml-20 w-40 h-0.5 bg-mas-red opacity-0 group-hover:opacity-100 animate-[scan_2s_ease-in-out_infinite] shadow-[0_0_10px_#C8102E] z-10 pointer-events-none"></div>
                                ...
                                <button 
                                    ...
                                    className="w-full py-5 bg-mas-red text-white uppercase shadow-[0_0_30px_rgba(200,16,46,0.3)] flex items-center justify-center gap-3 hover:bg-[#A60D26] hover:shadow-[0_0_40px_rgba(200,16,46,0.5)] transition-all transform active:scale-[0.98]"
                                >
                                    <Send size={18} />
