                    ...
                    {requests.map((req) => (
                        <tr key={req.id} className="group transition-all hover:bg-white/[0.01] block sm:table-row bg-[#161618] sm:bg-transparent border border-white/5 sm:border-none rounded-3xl sm:rounded-none mb-6 sm:mb-0 p-6 sm:p-0 shadow-2xl sm:shadow-none">
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                <span className="text-[14px] font-bold tracking-[0.2em] text-mas-red/60 uppercase block sm:hidden mb-3 text-left">Log ID</span>
                            ...
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                <span className="text-[14px] font-bold tracking-[0.2em] text-mas-red/60 uppercase block sm:hidden mb-3 text-left">Schedule Protocol</span>
                            ...
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 text-left sm:text-center border-b border-white/5 sm:border-none last:border-none">
                                <span className="text-[14px] font-bold tracking-[0.2em] text-mas-red/60 uppercase block sm:hidden mb-3 text-left">Dispatch Status</span>
                            ...
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 text-left sm:text-right">
                                <span className="text-[14px] font-bold tracking-[0.2em] text-mas-red/60 uppercase block sm:hidden mb-3 text-left">Control Matrix</span>
                                <button
                                    onClick={() => onQuickView(req)}
                                    className="inline-flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white/[0.02] border border-white/5 text-[13px] font-medium text-gray-300 uppercase tracking-widest hover:bg-mas-red hover:text-white hover:border-mas-red transition-all group shadow-lg"
                                >
                                    Transmit
