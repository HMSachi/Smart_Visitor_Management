                        ...
                        >
                            ...
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-5 text-left sm:text-right">
                                ...
                                <button
                                    ...
                                    className={`inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest transition-colors group ${isLight ? "text-gray-500 hover:text-primary" : "text-white/40 hover:text-primary"}`}
                                >
                                    View
