                    ...
                    {history.map((item) => (
                        <React.Fragment key={item.id}>
                            ...
                            >
                                ...
                                <td className="px-8 py-6">
                                    <span className="text-white/90 text-[11px] font-medium tracking-wide uppercase">{item.date}</span>
                                </td>
                                <td className="px-8 py-6">
                                    <span className="text-[10px] font-medium uppercase tracking-widest px-3 py-1 bg-white/[0.02] border border-white/5 rounded-lg text-gray-300">{item.category}</span>
                                </td>
