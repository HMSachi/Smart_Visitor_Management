                    ...
                    {requests.map((req) => (
                        <tr key={req.id} className="group transition-all hover:bg-white/[0.01] block sm:table-row bg-[#161618] sm:bg-transparent border border-white/5 sm:border-none rounded-3xl sm:rounded-none mb-6 sm:mb-0 p-6 sm:p-0 shadow-2xl sm:shadow-none cursor-pointer" onClick={() => onSelect(req)}>
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                ...
                                <span className="text-gray-300 text-[13px]">#{req.id}</span>
                            </td>
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary border border-primary/20 group-hover:bg-primary group-hover:text-white transition-all text-[13px]">
                                        {req.name[0]}
                                    </div>
                                    <span className="uppercase text-white group-hover:translate-x-1 transition-transform inline-block break-words text-[13px]">{req.name}</span>
                                </div>
                            </td>
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                ...
                                <span className="uppercase text-gray-500 text-[13px]">{req.date}</span>
                            </td>
                            <td className="block sm:table-cell px-2 sm:px-8 py-4 sm:py-6 border-b border-white/5 sm:border-none last:border-none">
                                ...
                                <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 border border-primary/20 text-primary uppercase break-words text-[12px]">
                                    <Octagon size={10} />
                                    {req.reason}
                                </div>
                            </td>
