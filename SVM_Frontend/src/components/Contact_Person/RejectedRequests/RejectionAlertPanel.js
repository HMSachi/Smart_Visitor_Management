        ...
        >
             <div className="mas-glass border-primary/30 p-10 bg-primary/[0.02] relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h3 className="uppercase text-white underline underline-offset-8 decoration-primary/30">Protocol Violation Audit</h3>
                </div>
             ...
             <div className="p-8 border border-white/5 bg-white/[0.01]">
                <div className="flex justify-between items-center uppercase">
                    ...
                    <span className="text-primary">R-BLOCK-4291</span>
                </div>
             </div>
        </motion.div>
    );
