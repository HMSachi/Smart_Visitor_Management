    ...
    return (
        <header className="h-20 mas-glass sticky top-0 z-40 px-8 flex items-center justify-between border-b border-white/[0.05]">
            <div className="flex items-center gap-8 flex-1">
                ...
                <div className="hidden lg:flex max-w-sm xl:max-w-md w-full relative group">
                    ...
                    <input
                        ...
                        className="mas-input w-full pl-12 pr-4 py-3 bg-white/[0.02] border border-white/5 focus:bg-white/[0.04] text-xs"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-4 md:gap-6">
                <div className="hidden md:flex flex-col items-end border-r border-white/10 pr-6">
                    <div className="flex items-center gap-2 text-mas-red">
                        ...
                        <span className="uppercase text-[10px] md:text-xs">MAS_NODE: 08A_COL</span>
                    </div>
                    <div className="flex items-center gap-2 text-mas-text-dim">
                        <Clock size={12} />
                        <span className="uppercase text-[10px] md:text-xs">14:18:22 GMT+5:30</span>
                    </div>
                </div>
