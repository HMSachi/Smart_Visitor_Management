  ...
  return (
    <div className="mas-glass h-full p-8 flex flex-col border-white/5">
      <div className="flex justify-between items-start mb-10">
        <div>
          <h2 className="text-lg font-black uppercase tracking-[0.2em] text-white">QR Clearance Node</h2>
          <p className="text-[10px] text-mas-text-dim uppercase tracking-widest mt-2 font-bold italic">Secure Token Generation & Verification</p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center border-y border-white/5 py-12 mb-8 bg-white/[0.01]">
        <div className="w-56 h-56 bg-white flex items-center justify-center p-4 relative group cursor-pointer shadow-[0_0_50px_rgba(255,255,255,0.05)]">
          <QrCode size={180} className="text-mas-black" strokeWidth={1.5} />
          <div className="absolute inset-0 border-2 border-mas-red opacity-0 group-hover:opacity-100 transition-all duration-500 scale-105"></div>
          
          {/* Corner accents */}
          <div className="absolute -top-1 -left-1 w-4 h-4 border-t-2 border-l-2 border-mas-red"></div>
          <div className="absolute -top-1 -right-1 w-4 h-4 border-t-2 border-r-2 border-mas-red"></div>
        ...
        <p className="mt-8 text-[11px] font-black text-white uppercase tracking-[0.3em]">Node: MAS-HQ-SEC-01</p>
        <p className="mt-2 text-[9px] text-mas-text-dim uppercase font-bold">Valid for next 12 hours</p>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between text-mas-text-dim">
        <div className="flex items-center gap-3">
          <Database size={14} />
          <span className="text-[9px] font-bold uppercase tracking-widest">Logs Syncing...</span>
        </div>
        <span className="text-[9px] font-bold uppercase tracking-widest text-green-500 italic">SECURE</span>
      </div>
    </div>
  );
};
