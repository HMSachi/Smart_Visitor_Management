        ...
        <div className="relative group p-8 bg-white flex flex-col items-center">
            ...
            <div className="w-full space-y-4 border-t border-gray-100 pt-8">
                <div className="flex justify-between items-end">
                    <span className="text-gray-500 uppercase">Authorized Holder</span>
                    <span className="text-black">{visitorData.name}</span>
                </div>
                <div className="flex justify-between items-end">
                    <span className="text-gray-500 uppercase">Security ID</span>
                    <span className="text-black">{visitorData.refId}</span>
                </div>
                <div className="flex justify-between items-end">
                    <span className="text-gray-500 uppercase">Valid Zone</span>
                    <span className="text-mas-red bg-mas-red/5 px-3 py-1 uppercase">{visitorData.zone}</span>
                </div>
            </div>
