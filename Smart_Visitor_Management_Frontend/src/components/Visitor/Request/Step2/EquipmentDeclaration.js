            ...
            <div className="space-y-8">
                {items.map((item) => (
                    <div key={item.id} className="grid grid-cols-1 md:grid-cols-4 gap-6 pb-8 border-b border-white/5 animate-slide-down relative">
                        ...
                        <input type="text" placeholder="ITEM NAME" className="bg-transparent border border-white/10 p-4 text-white uppercase placeholder-gray-400" />
                        <input type="number" placeholder="QTY" className="bg-transparent border border-white/10 p-4 text-white placeholder-gray-400" />
                        <input type="text" placeholder="DESCRIPTION" className="md:col-span-2 bg-transparent border border-white/10 p-4 text-white placeholder-gray-400" />
                    </div>
                ))}
