    ...
    return (
        <section className="bg-white/[0.02] border border-white/5 p-12">
            <div className="flex items-center space-x-6 mb-12">
                ...
                <h2 className="text-xl font-display font-black text-white uppercase tracking-widest">Identification</h2>
            </div>
            <div className="relative group/upload border-2 border-dashed border-white/10 p-12 text-center hover:border-mas-red/40 transition-all cursor-pointer">
                ...
                <p className="text-[10px] text-white uppercase tracking-[0.2em] font-bold">Drag & Drop ID Documents</p>
                <p className="text-[8px] text-gray-400 uppercase tracking-widest mt-2">PDF, JPG (MAX 5MB)</p>
                {uploadedFile && (
                    <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-between text-left">
                        <div className="flex-1 mr-4">
                            <p className="text-[10px] text-white uppercase tracking-widest truncate">{uploadedFile}</p>
                        ...
                        <span onClick={onRemove} className="text-[9px] text-mas-red font-black uppercase tracking-widest cursor-pointer hover:underline">REMOVE</span>
                    </div>
                )}
            </div>
        </section>
