    ...
    return (
        <section className="bg-white/[0.02] border border-white/5 p-12">
            <div className="flex items-center space-x-6 mb-12">
                ...
                <h2 className="text-xl font-display font-black text-white uppercase tracking-widest">Phase 1 Summary</h2>
            </div>
            <div className="space-y-6">
                {[
                    ...
                    <div key={item.label} className="flex justify-between items-end border-b border-white/5 pb-4">
                        <span className="text-[9px] text-gray-300 uppercase tracking-widest font-bold">{item.label}</span>
                        <span className="text-[10px] text-white uppercase tracking-widest font-black leading-none">{item.value}</span>
                    </div>
                ))}
            </div>
        </section>
