        ...
        <div className="min-h-screen bg-charcoal-900 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="max-w-md w-full glass-panel p-12 border-mas-red/10 relative z-10">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-300 uppercase mt-4">Secure Verification Node</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-8">
                    {/* Email Field */}
                    <div className="relative group">
                        <label className="uppercase text-gray-300 mb-2 block transition-colors group-focus-within:text-mas-red">Email Address</label>
                        <input 
                            type="email"
                            name="email"
                        ...
                        {errors.email && <span className="text-mas-red uppercase mt-2 block animate-fade-in">{errors.email}</span>}
                    </div>

                    {/* Phone Field */}
                    <div className="relative group">
                        <label className="uppercase text-gray-300 mb-2 block transition-colors group-focus-within:text-mas-red">Phone Number</label>
                        <input 
                            type="tel"
                            name="phone"
                        ...
                        />
                        <div className="absolute bottom-0 left-0 w-0 h-[1px] bg-mas-red group-focus-within:w-full transition-all duration-500 shadow-[0_0_10px_#C8102E]"></div>
                        {errors.phone && <span className="text-mas-red uppercase mt-2 block animate-fade-in">{errors.phone}</span>}
                    </div>

                    {/* Reference ID Field */}
                    <div className="relative group">
                        <label className="uppercase text-gray-300 mb-2 block transition-colors group-focus-within:text-mas-red">Reference ID</label>
                        <input 
                            type="text"
                            name="refId"
                        ...
                        />
                        <div className="absolute bottom-0 left-0 w-0 h-[1px] bg-mas-red group-focus-within:w-full transition-all duration-500 shadow-[0_0_10px_#C8102E]"></div>
                        {errors.refId && <span className="text-mas-red uppercase mt-2 block animate-fade-in">{errors.refId}</span>}
                    </div>
