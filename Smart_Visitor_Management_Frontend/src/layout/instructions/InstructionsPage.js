        ...
        <div className="min-h-screen bg-charcoal-900 pt-32 pb-24 px-6 overflow-hidden">
            <div className="max-w-6xl mx-auto">
                <header className="mb-20 animate-slide-down">
                    <span className="text-[10px] uppercase tracking-[0.5em] font-black text-mas-red block mb-4 italic">Operational Protocol</span>
                    <h1 className="text-5xl font-display font-black text-white uppercase tracking-tighter mb-8">Security Guidelines</h1>
                ...
                <div className="glass-panel p-12 border-mas-red/10 animate-fade-in stagger-item">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        <label className="flex items-start space-x-6 cursor-pointer group flex-1">
                            ...
                            <span className="text-[11px] text-gray-300 uppercase tracking-widest font-black leading-relaxed group-hover:text-white transition-colors">
                        ...
                        <button 
                            ...
                            className="px-20 py-6 bg-mas-red text-white text-[11px] font-black uppercase tracking-[0.3em] hover:bg-[#A60D26] disabled:opacity-20 transition-all hover:shadow-[0_0_40px_rgba(200,16,46,0.3)] whitespace-nowrap"
                        >
                            Finalize Clearance
                        </button>
                    </div>
